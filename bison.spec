...
Version  : 3.5.2
Release  : 41
URL      : https://mirrors.kernel.org/gnu/bison/bison-3.5.2.tar.xz
Source0  : https://mirrors.kernel.org/gnu/bison/bison-3.5.2.tar.xz
Source1  : https://mirrors.kernel.org/gnu/bison/bison-3.5.2.tar.xz.sig
...
%prep
%setup -q -n bison-3.5.2
cd %{_builddir}/bison-3.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581710300
...
cp %{_builddir}/bison-3.5.2/COPYING %{buildroot}/usr/share/package-licenses/bison/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
